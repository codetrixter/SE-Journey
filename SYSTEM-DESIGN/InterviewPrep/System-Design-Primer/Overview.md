...
3. [Availability vs Consistency (CAP Theorem)](#availability-vs-consistency-cap-theorem)
...
5. [Availability Patterns](#availability-patterns)
   - [Fail-over](#fail-over) (Active-Passive, Active-Active)
   - [Replication](#replication)
6. [Availability in Numbers](#availability-in-numbers)
   - [99.9% Availability — Three 9s](#999-availability---three-9s)
   - [99.99% Availability — Four 9s](#9999-availability---four-9s)
7. [Availability in Parallel vs in Sequence](#availability-in-parallel-vs-in-sequence)
   - [In Sequence](#in-sequence)
   - [In Parallel](#in-parallel)
8. [Domain Name Systems (DNS)](#domain-name-systems)
...
11. [Reverse Proxy (Web Server)](#reverse-proxy-web-server)
    - [Load Balancer vs Reverse Proxy](#load-balancer-vs-reverse-proxy)
12. [Application Layer](#application-layer)
    - [Microservices](#microservices)
    - [Service Discovery](#service-discovery)
13. [Relational Database Management System (RDBMS)](#relational-database-management-system-rdbms)
    - [ACID](#acid)
    - [Master-Slave Replication](#master-slave-replication)
    - [Master-Master Replication](#master-master-replication)
14. [Federation](#federation)
15. [Sharding](#sharding)
16. [Denormalization](#denormalization)
17. [SQL Tuning](#sql-tuning)
...
18. [NoSQL](#nosql)
19. [Key-Value Store](#key-value-store)
20. [Document Store](#document-store)
21. [Wide Column Store](#wide-column-store)
22. [Graph Database](#graph-database)
23. [SQL or NoSQL](#sql-or-nosql)
24. [Cache](#cache)
    ...
    - [When to Update the Cache](#when-to-update-the-cache) (Cache-Aside, Write-Through, Write-Behind, Refresh-Ahead)
25. [Asynchronism](#asynchronism)
...
27. [Remote Procedure Call (RPC)](#remote-procedure-call-rpc)
28. [Representational State Transfer (REST)](#representational-state-transfer-rest)
29. [RPC and REST Calls Comparison](#rpc-and-rest-calls-comparison)
...
- In some cases, the [query cache](https://dev.mysql.com/doc/refman/5.7/en/query-cache.html) could lead to performance issues.
...
> **Source**: [From cache to in-memory data grid](https://hazelcast.com/blog/a-hitchhikers-guide-to-caching-patterns/)
...
- [From cache to in-memory data grid](https://hazelcast.com/blog/a-hitchhikers-guide-to-caching-patterns/)
...
> **Source**: [Intro to architecting systems for scale](http://lethain.com/introduction-to-architecting-systems-for-scale/)
...
> **Source**: [OSI 7 layer model](https://en.wikipedia.org/wiki/OSI_model)
...
> **Source**: [How to make a multiplayer game](http://ithare.com/64-network-dos-and-donts-for-game-engines-part-i-client-side/)
...
- [Networking for game programming](http://ithare.com/64-network-dos-and-donts-for-game-engines-part-i-client-side/)
